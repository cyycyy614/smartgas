...
public class WorkOrderListActivity extends AppCompatActivity {
    ...
    private void initContent(){
        ...
        tabIndicators.add("已关闭");
        ArrayList tabCodeList = new ArrayList<>();
        tabCodeList.add("");
        tabCodeList.add("handling");
        tabCodeList.add("handled");
        tabCodeList.add("closed");
        tabFragments = new ArrayList<>();
        for(int i = 0;i < tabIndicators.size(); i ++){
            tabFragments.add(WorkOrderListFragment.newInstance((String) tabCodeList.get(i)));
        }
